...
function Collaboration() {
  return (
    ...
    crosses
    >
      <div className='container ml-2 lg:flex'>
        ...
        <div className='lg:ml-auto mt-4 xl:w-[38rem]'>
          <p className='body-2 mb-4 text-n-4 md:mb-16 lg:mb-32 lg:w-[22rem] lg:mx-auto'>{collabText}</p>
            ...
            <div className='relative left-1/2 flex w-[22rem] aspect-square border border-n-6 rounded-full -translate-x-1/2 scale-75 md:scale-100 mt-4 '>
              ...
              <div className='flex w-60 aspect-square border m-auto border-n-6 rounded-full '>
              ...
              <ul>
                {collabApps.map((item,index) =>(
                  ...
                  >
                    <div className={`relative -top-[1.6rem] flex w-[3.2rem] h-[3.2rem] bg-n-7 border border-n-1/16 rounded-xl -rotate-${index*45} `}>
                      <img src={item.icon} 
                      className='m-auto' height={item.height} width={item.width} 
                      alt={item.title} />
                    </div>
                  </li>
                ))}
