...
import braniwave from '../assets/brainwave.svg'
...
function Header() {
  ...
  return (
    <div className={`fixed left-0 w-full top-0 z-50  border-b border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm
    ${openNavigation ? 'bg-n-8' : 'bg-n-8/90 backdrop-blur-sm'
      ...
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        ...
        <a href="#hero" className='block w-[12rem] xl:mr-8'>
          <img src={braniwave} width={190} height={40} alt='BrainWave' />
        </a>
        ...
        <nav className={` fixed top-[5rem] left-0 right-0 bottom-0 bg-n-8 lg:static lg:flex lg:mx-auto lg:bg-transparent 
          ...
          <HamburgerMenu />
            ...
            <a href="#signup" className='button hidden text-n-1/50 mr-8 transition-colors hover:text-n-1 lg:block'>
              New Account
            </a>
